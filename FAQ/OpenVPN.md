...
1. Download the installation file from the [webpage](https://openvpn.net/community/) or Alga drive at `\\192.168.1.2.\programs\vpn\VPN\OpenVPN-x.x.x-I0001-amd64.msi`
